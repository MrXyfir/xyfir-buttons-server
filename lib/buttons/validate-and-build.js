 ...
 * @param {boolean} [button.isListed] - If present and truthy, the button will be
      ...
      if (button.repository) {
        ...
        request
          ...
          .end((err, res) => {
            ...
            if (!res.body.files['main.js'] || !req.body.files['main.js'].content)
            ...
            Object.keys(res.body.files).forEach(file => {
              ...
              button.script[file] = file.content;
            });
