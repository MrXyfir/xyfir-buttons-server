 ...
 * @param {string} [button.styles] - A string (not JSON) of an HTMLElement.style
 * object containing the button's custom styles. Will be eval()'d on the client
...
module.exports = function(button) {
  ...
  return new Promise((resolve, reject) => {
    ...
    try {
      ...
      else if (button.styles[buttons.styles.length - 1] != '}')
